var data= {
    chatinit:{
        ...
        options: ["About ","Movies <span class='emoji'> &#128250;</span>","News","Shopping ","Music ","KnowMore<span class='emoji'> &#128250;</span>" , "ApplyLeave"]
    ...
    about:{
        title:["Ellipsonic"],
        options:["Service", "Products"],
        url:{}
    },
    products:{
        title:["dchbsjd"],
        options:["SmartGuru", "ETOW", "SMS", "EarOne"],
        url:{}
    },
    
    smartguru:{
        title:["A Smart Guru is Question Paper Generating Software."],
        options:[],
        url : {}
    },
